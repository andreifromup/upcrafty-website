            ...
            <section className="mb-16 snap-start">
              ...
              <div className="space-y-8">
                <p className="text-base md:text-lg leading-relaxed max-w-3xl">
                  We're <span className="font-bold">Upcrafty</span>, a creative studio formed by a team of five professionals — <span className="text-[#FF6512]">each specialized in their own area</span>:
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="group bg-white p-6 rounded-xl border-t border-gray-100 shadow-sm md:hover:shadow-md transition-all duration-300">
                    <h4 className="text-base md:text-lg font-bold mb-3 flex items-center">
                      <div className="bg-[#EDEAE7] rounded-full p-1.5 mr-2">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="#FF6512" className="w-5 h-5">
                          <path strokeLinecap="round" strokeLinejoin="round" d="M15 19.128a9.38 9.38 0 0 0 2.625.372 9.337 9.337 0 0 0 4.121-.952 4.125 4.125 0 0 0-7.533-2.493M15 19.128v-.003c0-1.113-.285-2.16-.786-3.07M15 19.128v.106A12.318 12.318 0 0 1 8.624 21c-2.331 0-4.512-.645-6.374-1.766l-.001-.109a6.375 6.375 0 0 1 11.964-3.07M12 6.375a3.375 3.375 0 1 1-6.75 0 3.375 3.375 0 0 1 6.75 0Zm8.25 2.25a2.625 2.625 0 1 1-5.25 0 2.625 2.625 0 0 1 5.25 0Z" />
                        </svg>
                      </div>
                      <span className="md:group-hover:text-[#FF6512] transition-colors duration-300">Team Collaboration</span>
                    </h4>
                    <p className="text-gray-700 text-sm md:text-base">
                      <span className="text-[#FF6512]">We work closely together</span> on every project. While each of us has a clear role, we often collaborate across <span className="italic font-normal">disciplines </span>
                  ...
                  <div className="group bg-white p-6 rounded-xl border-t border-gray-100 shadow-sm md:hover:shadow-md transition-all duration-300">
                    <h4 className="text-base md:text-lg font-bold mb-3 flex items-center">
                      ...
                      <span className="md:group-hover:text-[#FF6512] transition-colors duration-300">Extensive Experience</span>
                    </h4>
                    <p className="text-gray-700 text-sm md:text-base">
                      Our brand has been active for the past 3 years, but our combined experience spans over <span className="text-[#FF6512] font-medium">6 to 15+ years</span> in our respective fields.
                    </p>
                  </div>
                </div>
            ...
            <section className="mb-16 snap-start p-6 rounded-lg bg-[#FAFAFA]">
              ...
              <div className="space-y-8">
                <p className="text-base md:text-lg leading-relaxed max-w-3xl">
                  ...
                  Whether it's a game, mobile app, website, or brand — we can handle the entire journey, from <span className="text-[#FF6512] font-medium">concept to launch</span>.
                </p>
                
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                  <div className="group bg-white p-5 rounded-lg shadow-sm md:hover:shadow-md transition-all duration-300">
                    <h4 className="font-bold text-base md:text-lg mb-2 md:group-hover:text-[#FF6512] transition-colors duration-300">Project Packages</h4>
                  ...
                  <div className="group bg-white p-5 rounded-lg shadow-sm md:hover:shadow-md transition-all duration-300">
                    <h4 className="font-bold text-base md:text-lg mb-2 md:group-hover:text-[#FF6512] transition-colors duration-300">Illustration, Animation & Design</h4>
                    <p className="text-gray-700 text-sm md:text-base">Branding, illustration, UI/UX, web & visual design, and 2D animation</p>
                  </div>
                  
                  <div className="group bg-white p-5 rounded-lg shadow-sm md:hover:shadow-md transition-all duration-300">
                    <h4 className="font-bold text-base md:text-lg mb-2 md:group-hover:text-[#FF6512] transition-colors duration-300">3D Design</h4>
                    <p className="text-gray-700 text-sm md:text-base">Modeling, rigging, environment & character art, and 3D animation</p>
                  </div>
                  
                  <div className="group bg-white p-5 rounded-lg shadow-sm md:hover:shadow-md transition-all duration-300">
                    <h4 className="font-bold text-base md:text-lg mb-2 md:group-hover:text-[#FF6512] transition-colors duration-300">Game Development</h4>
                  ...
                  <div className="group bg-white p-5 rounded-lg shadow-sm md:hover:shadow-md transition-all duration-300">
                    <h4 className="font-bold text-base md:text-lg mb-2 md:group-hover:text-[#FF6512] transition-colors duration-300">Web Development</h4>
                    <p className="text-gray-700 text-sm md:text-base">Responsive websites and web apps – design, development, and deployment</p>
                  </div>
                  
                  <div className="group bg-white p-5 rounded-lg shadow-sm md:hover:shadow-md transition-all duration-300">
                    <h4 className="font-bold text-base md:text-lg mb-2 md:group-hover:text-[#FF6512] transition-colors duration-300">Sound Design</h4>
              ...
              <div className="space-y-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="group flex gap-4 items-center bg-white p-5 rounded-lg shadow-sm md:hover:shadow-md transition-all duration-300">
                    ...
                    <div>
                      <h4 className="font-bold text-base md:text-lg md:group-hover:text-[#FF6512] transition-colors duration-300">Full Creative Team</h4>
                      <p className="text-gray-700 text-sm md:text-base mt-1">Covers <span className="text-[#FF6512] font-medium">all creative areas</span> in-house</p>
                    </div>
                  </div>
                  ...
                  <div className="group flex gap-4 items-center bg-white p-5 rounded-lg shadow-sm md:hover:shadow-md transition-all duration-300">
                    ...
                    <div>
                      <h4 className="font-bold text-base md:text-lg md:group-hover:text-[#FF6512] transition-colors duration-300">Strong Collaboration</h4>
                      <p className="text-gray-700 text-sm md:text-base mt-1">Ensures <span className="text-[#FF6512] font-medium">fast delivery</span> on projects</p>
                    </div>
                  </div>
                  ...
                  <div className="group flex gap-4 items-center bg-white p-5 rounded-lg shadow-sm md:hover:shadow-md transition-all duration-300">
                    ...
                    <div>
                      <h4 className="font-bold text-base md:text-lg md:group-hover:text-[#FF6512] transition-colors duration-300">Clear Communication</h4>
                      <p className="text-gray-700 text-sm md:text-base mt-1"><span className="text-[#FF6512] font-medium">Step-by-step</span> approach throughout</p>
                    </div>
                  </div>
                  ...
                  <div className="group flex gap-4 items-center bg-white p-5 rounded-lg shadow-sm md:hover:shadow-md transition-all duration-300">
                    ...
                    <div>
                      <h4 className="font-bold text-base md:text-lg md:group-hover:text-[#FF6512] transition-colors duration-300">Personalized Approach</h4>
                      <p className="text-gray-700 text-sm md:text-base mt-1">Understanding your <span className="text-[#FF6512] font-medium">unique vision</span></p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-black text-white p-6 rounded-lg">
                  <p className="mb-0 text-base md:text-lg leading-relaxed">
                    We've completed <span className="text-[#FF6512] font-medium">over 50 projects</span> so far, mostly with startups and early-stage teams. 
                  ...
                  <div className="max-w-3xl mx-auto">
                    <div className="space-y-6">
                      <p className="text-base md:text-lg leading-relaxed">
                        ...
                        not just visually, but in <span className="text-[#FF6512] font-medium">every detail</span>. 
