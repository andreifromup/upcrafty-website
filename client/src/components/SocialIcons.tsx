...
const SocialIcons: React.FC = () => {
  ...
  return (
    <div className="flex items-center space-x-4">
      ...
      >
        <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          <path d="M9 12.75A3.75 3.75 0 0112.75 9v0a3.75 3.75 0 013.75 3.75V19.5a3.75 3.75 0 01-3.75 3.75h-6a3.75 3.75 0 01-3.75-3.75V8.25a3.75 3.75 0 013.75-3.75h3M16.5 8.25V2.25m0 0h-3m3 0v0A3.75 3.75 0 0120.25 6v0" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
        </svg>
      </a>
